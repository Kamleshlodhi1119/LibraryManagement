...
<div class="">
            <button onclick="toggleAddBookForm('addBookForm')"> New Book </button>
            <button onclick="toggleAddBookForm('register')"> Register member   </button>
            <button onclick="toggleAddBookForm('delete')"> delete Member  </button>
